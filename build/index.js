...
class Search {
  ...
  constructor() {
    ...
    this.closeIcon = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-overlay__close');
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().when(jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/wp/v2/posts?search=' + this.inputSearch.val()), jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/wp/v2/pages?search=' + this.inputSearch.val())).then((posts, pages) => {
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()('input, textarea').is(':focus') // any other input or textarea is focused don't trigger the searchOverlay
    ) {
      this.openOverlay();
    }
